...
public class AwkwardMedicineBottleItem extends Item {
    private static final int DRINK_DURATION = 40;

    public AwkwardMedicineBottleItem(Properties p_41346_) {
        super(p_41346_);
    }
    ...
    public void appendHoverText(ItemStack p_41211_, @Nullable Level p_41212_, List<Component> p_41213_, TooltipFlag p_41214_) {
        {
            ...
            p_41213_.add(Component.translatable("item.marbledsfirstaid.awkward_medicine_bottle.desc1").withStyle(ChatFormatting.GRAY));
        }
    }
}
