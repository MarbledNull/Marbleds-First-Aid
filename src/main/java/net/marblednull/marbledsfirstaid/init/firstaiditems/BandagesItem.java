    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        {
            ...
            tooltipComponents.add(Component.translatable("item.marbledsfirstaid.bandages.desc1").withStyle(ChatFormatting.GRAY));
            tooltipComponents.add(CommonComponents.space().append(Component.translatable("item.marbledsfirstaid.bandages.desc2")).withStyle(ChatFormatting.BLUE));
        }
    }
}
