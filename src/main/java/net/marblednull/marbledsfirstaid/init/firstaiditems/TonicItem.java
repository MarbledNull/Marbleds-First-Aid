...
public class TonicItem extends Item {
    ...
    public TonicItem(Properties p_41346_) {
        super(p_41346_);
    }
    ...
    public ItemStack finishUsingItem(ItemStack p_41348_, Level p_41349_, LivingEntity p_41350_) {
        ...
        if (!p_41349_.isClientSide) {
            p_41350_.removeEffect(MobEffects.CONFUSION);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        {
            ...
            tooltipComponents.add(Component.translatable("item.marbledsfirstaid.tonic.desc1").withStyle(ChatFormatting.GRAY));
            tooltipComponents.add(CommonComponents.space().append(Component.translatable("item.marbledsfirstaid.tonic.desc2")).withStyle(ChatFormatting.BLUE));
            tooltipComponents.add(CommonComponents.space().append(Component.translatable("item.marbledsfirstaid.tonic.desc3")).withStyle(ChatFormatting.BLUE));
        }
    }
}
