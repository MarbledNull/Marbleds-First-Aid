...
public class TonicItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41212_, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        {
            tooltipComponents.add(CommonComponents.EMPTY);
            tooltipComponents.add(Component.translatable("item.marbledsfirstaid.whenused.desc1").withStyle(ChatFormatting.GRAY));
            tooltipComponents.add(CommonComponents.space().append(Component.translatable("item.marbledsfirstaid.tonic.desc1")).withStyle(ChatFormatting.BLUE));
